...
function About() {
  return (
    <section className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-4 w-full fixed left-0 shadow-md max-h-screen bg-cover bg-center bg-no-repeat" >
      ...
      {/* <p className="text-lg text-gray-600 mb-4">
        In my free time, I love to work on personal projects, contribute to open-source, and explore new technologies.
